         ...
         <div className="flex justify-center">
            <div className="mb-3 xl:w-96">
               <form onSubmit={handleSubmit} className="relative">
                  <input type="search" onChange={handleChange} className="h-8 p-4 text-sm w-full border" placeholder="Search" aria-label="Search" aria-describedby="button-addon2"></input>
